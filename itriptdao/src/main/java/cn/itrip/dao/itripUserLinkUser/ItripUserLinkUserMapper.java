...
import cn.itrip.common.ItripAddUserLinkUserVO;
import cn.itrip.common.ItripModifyUserLinkUserVO;
import cn.itrip.common.ItripSearchUserLinkUserVO;
...
public interface ItripUserLinkUserMapper {
	...
	public Integer updateItripUserLinkUserOv(ItripModifyUserLinkUserVO itripModifyUserLinkUserVO)throws Exception;
	public Integer deleteItripUserLinkUserById(@Param(value = "id") Long id)throws Exception;
	public Integer insertItripLinkUserVO(ItripAddUserLinkUserVO itripAddUserLinkUserVO);
	public List<ItripUserLinkUser>getItripUserLinkUserByName(ItripSearchUserLinkUserVO itripSearchUserLinkUserVO);
